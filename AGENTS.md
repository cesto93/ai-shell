...
make install-litertlm  # fetch LiteRT-LM prebuilt aux/GPU libs + symlink liblitertlm_c_cpu.so; requires liblitert-lm.so from the litertlm.yaml workflow already in ~/.ai-shell/lib
