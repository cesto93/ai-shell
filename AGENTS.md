...
make install-litertlm  # fetch LiteRT-LM prebuilt aux/GPU libs; requires liblitertlm_c_cpu.so from the litertlm.yaml workflow already in ~/.ai-shell/lib
